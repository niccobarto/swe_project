...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.80\linewidth]{images/createDocumentRelationship.png}
    \caption{Mockup: creazione di una relazione tra documenti}
    \label{fig:mockup-document-relationship}
\end{figure}
\begin{figure}[H]
\centering
